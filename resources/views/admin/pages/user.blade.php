    ...
    <div class="row">
      <div class="col">
        <div class="card">
          ...
          {{-- <form action="{{url('/admin/users/filter')}}" method="post" class="ml-4" id="filter_revene_form">
            @csrf
                        ...
                        <tr>
                            ...
                            <td class="table-actions">
                              @php
                                $base_url = url('/');
                            @endphp
                                <a href="{{url('admin/users/'.$user->id)}}" class="table-action text-warning" data-toggle="tooltip" data-original-title="{{__('View client')}}">
